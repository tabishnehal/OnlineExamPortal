...
if(isset($_POST['submit'])){
   require 'require/connection.php';
    ...
    $cty = $_POST['City'];
$sql =<<<EOF
        INSERT INTO STUDENT (name,email,password,contact,city,loginvalue) 
	VALUES ('$nm', '$em', '$hash', '$ct','$cty',0);
EOF;
$ret = @pg_query($db, $sql);
   if(!$ret) {
	...
	?>
	<a href="Std_Login.php"><h4>Click to Login</h4></a>
<?php
	}	
   pg_close($db);
}
?>
        <form action="Std_Signup.php" method="POST">
            <h2>SIGN UP</h2>
